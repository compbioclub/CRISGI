import torch
import sys
from src.simplecnn.autoEncoder import AE
import src.simplecnn.autoEncoder
from src.simplecnn.mlp import MLP
import src.simplecnn.mlp
from src.simplecnn.train import train as train_loop

sys.modules['autoEncoder'] = src.simplecnn.autoEncoder
sys.modules['mlp'] = src.simplecnn.mlp
