import sys
import torch
from src.cnn.autoEncoder import AE
import src.cnn.autoEncoder
from src.cnn.mlp import MLP
import src.cnn.mlp
from src.cnn.train import train as train_loop

sys.modules['autoEncoder'] = src.cnn.autoEncoder
sys.modules['mlp'] = src.cnn.mlp
